...
13. subtract val_1 - val_2 and assign the value to current element of matrix_c
14. display the subtracted matrix
...
// Display the Subtraction of matrix A & B
    printf("\nMatrix A - Matrix B:\n");
    for (int i = 0; i < arr_c_size; i++) {
        printf("|");
        for (int j = 0; j < arr_c_size; j++) {
